    ...
    public static Company[] getSampleCompanies() {
        return new Company[] {
            ...
            new Company(
                    ...
                    new Description("A streaming service company."), getTagSet(), new HashSet<>()),
            new Company(
                    ...
                    getTagSet("social", "advertising"), new HashSet<>()),
            new Company(
                    ...
                    getTagSet("automotive", "sustainability"), new HashSet<>())
        };
