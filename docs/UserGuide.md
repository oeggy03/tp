...
| List   | `list c`, `list p`                 |                                                                                                                                                                                                       |
| Delete | `delete c INDEX`, `delete p INDEX`, `delete i` | e.g., `delete p 3`, `delete i c/2 i/1`                                                                                                                                                                                 |
| View   | `view c INDEX`, `view p INDEX`     | e.g., `view c 1`                                                                                                                                                                                      |
| Edit   | `edit c INDEX`, `edit p INDEX`, `edit i`    | e.g., `edit p 1 n/John p/98765432 e/john@example.com a/311, Clementi Ave 2, #02-26 t/friend`;<br> `edit c 1 n/Alpha p/98765432 e/alpha@example.com d/A cool company t/tech`;<br> `edit i c/2 i/1 n/Software Engineering`                           |                                                                                                                                                                                    |
